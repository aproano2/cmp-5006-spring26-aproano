...
El documento principal para revision academica es [report/final_report.md](report/final_report.md). Ese archivo resume los cinco literales y apunta a las evidencias y anexos tecnicos correspondientes.
...
1. Leer el informe final: [report/final_report.md](report/final_report.md)
...
### 1. OWASP, CWE y CVE
Se eligieron tres categorias del OWASP Top 10:2025 y se verifico que el CWE seleccionado aparezca en la lista oficial mapeada por OWASP. Luego se confirmo cada CVE en NVD y, cuando existia, se contrasto con el advisory oficial del proveedor o base primaria asociada.
...
|---|---|---|---|
| A05:2025 Injection | CWE-89 | CVE-2025-25257 | SQL Injection no autenticada en FortiWeb |
| A01:2025 Broken Access Control | CWE-863 | CVE-2025-29927 | Bypass de autorizacion en middleware de Next.js |
| A08:2025 Software or Data Integrity Failures | CWE-502 | CVE-2025-27130 | Deserializacion insegura en Welcart e-Commerce |
