...
### Vulnerabilidad / mala practica representada
Este reto ilustra **CWE-89: SQL Injection** y, en particular, el patron de defensa fallida basado en **denylist de palabras clave** en lugar de **consultas parametrizadas** (prepared statements). Mapea a OWASP A03:2021 Injection. Lecciones clave:
